...
public class Sign_Up{
    ...
    public static void main(String[] args) {
        ...
        JLabel label = new JLabel("Welcome To Snyder Bank ",SwingConstants.CENTER);
        label.setForeground(Color.PINK);
        label.setFont(new Font("Serif", Font.BOLD, 18));
        label.setBounds(0, 20, frame.getWidth(), 50);

        // Add an image to the window
        ImageIcon pic = new ImageIcon("resources\\background.png"); // Replace with your image path
        ...
        Sign_Up.setBounds(200, 730, 80, 30);
